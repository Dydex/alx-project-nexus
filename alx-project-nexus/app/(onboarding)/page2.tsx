      ...
      <GestureDetector gesture={onGestureEvent}>
        <View style={styles.containerTwo}>
          <View style={styles.imageGroup}>
            <Image source={require("@/assets/images/Campanha.png")} />
          </View>

          <Indicator activeIndex={1} />

          <View style={styles.mainTextDiv}>
            <Text style={styles.mainText}>Create interesting polls </Text>
            <Text style={styles.mainText}>and get answers, quickly</Text>
          </View>

          <View style={styles.subTextDiv}>
            <Text style={styles.subText}>
              {" "}
              People will respond to your polls in no time
            </Text>
          </View>
